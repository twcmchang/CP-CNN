...
CUDA_VISIBLE_DEVICES=$1 python3 train.py --tesla 1 --decay $4 --keep_prob $5 --init_from $6/sparse_dict.npy --save_dir $6
CUDA_VISIBLE_DEVICES=$1 python3 test.py --keep_prob $5 --init_from $6/finetune_dict.npy --output $6/output.csv
